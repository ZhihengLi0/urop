#!/usr/bin/env python3
# coding: utf-8
# Template shape overlay plots for the eighth iteration.
# Reads AllZips merged ROOT file (agnostic or specific) and per-zip caches.
# Usage: python plot_templates_v8.py --mode agnostic|specific
...
for det in ZIPS:
        ...
        with uproot.open(root_path) as f:
            ...
            for i in range(n_comp):
                ...
                try:
                    ...
                    axes3[i].set_title(label, fontsize=10)
    ...
    if ch_traces:
        ...
        if chans_avail:
            ...
            fig4.suptitle(f'Zip{det} — 4 kHz LP Aligned Traces', fontsize=13)
