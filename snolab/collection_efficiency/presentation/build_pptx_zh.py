...
# --------------------------------------------------- 3 公式是怎么来的
s = new("公式是怎么来的", "薄膜吸收的能量，是从它自己的焦耳热里“扣掉”的")
pic(s, "circuit.png", L, T, Inches(4.85), Inches(4.8))
pic(s, "derivation.png", Inches(5.6), T, Inches(7.25), Inches(4.8))
lines(s, [
    "事件把薄膜加热，电阻升高，电流下降 —— 焦耳热正好少掉事件送进来的那一份（负电热反馈）。",
    "!所以吸收的能量完全可以从电流读出来：E = −∫δP_J dt，也就是下一页那个公式。",
    "没有算进去的：热泄漏项和电感边界项。两者都需要 dI/dV 给出的 G 和 L，这些 series 没有这个数据。",
